    ...
    var $addTagButton = $('<button type="button" class="add_tag_link">Ajouter un mot clé</button>');
    var $delTagButton = $('<button type="button" class="del_tag_link">Supprimer</button>');
